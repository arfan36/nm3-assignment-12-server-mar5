...
async function run() {
	try {
		...
		// 		const user = req.body;
		// 		const alreadySaved = await usersCollection
		...
		// 		res.send(
		// 			await categoryCollection.find({}).project({ categoryName: 1 }).toArray()
		// 		);
		// 	});
		...
		// 		res.send(
		// 			await phoneCollection.deleteOne({ _id: ObjectId(req.params.id) })
		// 		);
		// 	});
		// 	// get advertised product
		// 	app.get("/advertised", verifyJWT, async (req, res) => {
		// 		res.send(
		// 			await phoneCollection.find({ advertised: true, paid: null }).toArray()
		// 		);
		// 	});
		...
		// 		res.send(
		// 			await phoneCollection
		// 				.find({ advertised: true, paid: null })
		// 				.limit(2)
		// 				.toArray()
		// 		);
		// 	});
		...
		// 		res.send(
		// 			await bookedCollection
		// 				.find({ buyerEmail: req.query.buyerEmail })
		// 				.toArray()
		// 		);
		// 	});
		...
		// 		res.send(
		// 			await bookedCollection.findOne({ _id: ObjectId(req.params.id) })
		// 		);
		// 	});
		...
		// 		res.send(
		// 			await bookedCollection.deleteOne({ _id: ObjectId(req.params.id) })
		// 		);
		// 	});
		...
		// 	app.delete(
		// 		"/reported-product/:phoneId",
		// 		verifyJWT,
		// 		verifyAdmin,
		// 		async (req, res) => {
		// 			await phoneCollection.deleteOne({ _id: ObjectId(req.params.phoneId) });
		// 			res.send(
		// 				await reportedCollection.deleteOne({ phoneId: req.params.phoneId })
		// 			);
		// 		}
		// 	);
